...
| **Quantization** | export-time dynamic int8 on linears + embedding (dynamic_wi8_afp32), one TFLite section (4.24 GB); prefer_activation_type fp32 declared in-bundle (with the runtime's default fp16 GPU activations the same weights scored GSM8K 84 vs 94) |

## Artifacts

| File | SHA-256 | Size (MB) |
|---|---|---|
| `Spark-X2.5-4B_int8.litertlm` | `20179c7be4f2aa1a04e77c3b2cc64794a429417d83b89c7a91f7125b8ca5fea6` | 4041.75 |
...
Model-level on-device results — measured behavior of this exact artifact on the recorded device, only meaningful together with that environment. Throughput is conditional on the measured prompt length (Prompt (tokens); '-' = the source stated none): rows differing only there are different measurements, not re-runs. Full records (failure classes, log evidence): `data/device_runs/0.15.0/2026-09-07/spark-x2.5-4b-int8__iphone-17-pro.json`, `data/device_runs/0.16.0/2026-09-07/spark-x2.5-4b-int8__galaxy-s26.json`, `data/device_runs/0.17.0/2026-09-07/spark-x2.5-4b-int8__mac-studio-m4-max.json`.

| Device | Accelerator | Status | Full delegation | Output match | Prompt (tokens) | Latency p50 (ms) | Prefill tok/s | Decode tok/s | TTFT (ms) | Peak mem (MB) | Environment | Date | Provenance |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| galaxy-s26 | cpu | fallback | no | - | 213 | - | 65.14 | 4.55 | 3490.0 | - | Galaxy S26 (SM-S942Q) · Qualcomm SM8850 · litert-lm 0.16.0 · Android 16 | 2026-09-07 | measured |
| galaxy-s26 | gpu | pass | yes | - | - | - | - | - | - | 1674.0 | Galaxy S26 (SM-S942Q) · Qualcomm SM8850 · litert-lm 0.16.0 · Android 16 | 2026-09-07 | measured |
...
| mac-studio-m4-max | cpu | pass | - | - | - | - | 345.4 | 19.5 | 792.5 | - | Mac Studio (M4 Max) · litert-lm 0.17.0 | 2026-09-07 | measured |
| mac-studio-m4-max | gpu | pass | - | - | - | - | 783.88 | 49.38 | 346.9 | - | Mac Studio (M4 Max) · litert-lm 0.17.0 | 2026-09-07 | measured |

## Pitfalls

- int8 (4.24 GB) is the CPU-prefill file (345 vs 118 tok/s on the Mac CPU); int4 block-128 is the recommended file at the same accuracy (HF card).
- iPhone int8 legs 8/8 on both backends; Galaxy S26 CPU decode 4.5-4.7 tok/s at 5553 MB peak RSS (HF card Performance).
