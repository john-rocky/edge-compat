...
family: sarashina2.2
license: mit
model_id: sarashina2.2-1b-instruct-v0.1-int8
source_url: https://huggingface.co/litert-community/sarashina2.2-1b-instruct-v0.1
task: text-generation
---

# sarashina2.2-1b-instruct-v0.1-int8

| | |
|---|---|
| **Task** | text-generation |
| **Family** | sarashina2.2 |
| **Source** | https://huggingface.co/litert-community/sarashina2.2-1b-instruct-v0.1 |
| **License** | mit |
...
|---|---|---|
| `sarashina2.2-1b-instruct-v0.1_int8.litertlm` | `6b9967b24dbf7af4252a671f9f255400905ed940f47ddeccc86eb10d2b96bee5` | 1435.003 |
...
Model-level on-device results — measured behavior of this exact artifact on the recorded device, only meaningful together with that environment. Throughput is conditional on the measured prompt length (Prompt (tokens); '-' = the source stated none): rows differing only there are different measurements, not re-runs. Full records (failure classes, log evidence): `data/device_runs/0.16.0/2026-09-02/sarashina2.2-1b-instruct-v0.1-int8__galaxy-s26.json`, `data/device_runs/0.16.0/2026-09-02/sarashina2.2-1b-instruct-v0.1-int8__mac-studio-m4-max.json`, `data/device_runs/0.16.0/2026-09-07/sarashina2.2-1b-instruct-v0.1-int8__pixel-8a.json`.

| Device | Accelerator | Status | Full delegation | Output match | Prompt (tokens) | Latency p50 (ms) | Prefill tok/s | Decode tok/s | TTFT (ms) | Peak mem (MB) | Environment | Date | Provenance |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| galaxy-s26 | cpu | fallback | no | - | 321 | - | 168.03 | 13.35 | 1990.0 | - | Galaxy S26 (SM-S942Q) · Qualcomm SM8850 · litert-lm 0.16.0 · Android 16 | 2026-09-02 | measured |
| galaxy-s26 | gpu | pass | yes | - | 321 | - | 585.61 | 23.7 | 590.0 | - | Galaxy S26 (SM-S942Q) · Qualcomm SM8850 · litert-lm 0.16.0 · Android 16 | 2026-09-02 | measured |
| mac-studio-m4-max | cpu | pass | - | - | - | - | 822.37 | 35.14 | 843.6 | - | Mac Studio (M4 Max) · litert-lm 0.16.0 | 2026-09-02 | measured |
| mac-studio-m4-max | gpu | pass | - | - | - | - | 3554.22 | 146.4 | 89.6 | - | Mac Studio (M4 Max) · litert-lm 0.16.0 | 2026-09-02 | measured |
| pixel-8a | cpu | fallback | no | - | 321 | - | 95.47 | 9.5 | 3470.0 | - | Pixel 8a · Tensor G3 · litert-lm 0.16.0 · Android 16 | 2026-09-07 | measured |

## Pitfalls

- Quality: 8-question gate (Apple M4 Max, litert-lm 0.16 lineage, one process per question, greedy) EN/JA — see HF card Correctness table; JCommonsenseQA (own harness, n=100): bf16 75 / int8 76 / int4 77 — within paired noise (HF card Accuracy; FINDINGS).
...
- On the 1b, int4 loses no accuracy (JCQA 77 vs bf16 75) and decodes 17% faster on the S26 GPU and 9% faster on the Mac GPU at ~40% smaller size, but its CPU prefill is more than 2x slower — int4 for GPU / size-constrained deployments, int8 for CPU-centric ones (HF card 1b).
