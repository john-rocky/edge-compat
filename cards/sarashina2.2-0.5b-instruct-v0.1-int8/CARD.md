...
|---|---|---|
| `sarashina2.2-0.5b-instruct-v0.1_int8.litertlm` | `b1e7410d9f7b9c465e37da313ca4951eb012b3e022712ec5bfee11064dae11e3` | 830.518 |
...
Model-level on-device results — measured behavior of this exact artifact on the recorded device, only meaningful together with that environment. Throughput is conditional on the measured prompt length (Prompt (tokens); '-' = the source stated none): rows differing only there are different measurements, not re-runs. Full records (failure classes, log evidence): `data/device_runs/0.16.0/2026-09-02/sarashina2.2-0.5b-instruct-v0.1-int8__galaxy-s26.json`, `data/device_runs/0.16.0/2026-09-02/sarashina2.2-0.5b-instruct-v0.1-int8__mac-studio-m4-max.json`, `data/device_runs/0.16.0/2026-09-05/sarashina2.2-0.5b-instruct-v0.1-int8__pixel-8a.json`.

| Device | Accelerator | Status | Full delegation | Output match | Prompt (tokens) | Latency p50 (ms) | Prefill tok/s | Decode tok/s | TTFT (ms) | Peak mem (MB) | Environment | Date | Provenance |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| galaxy-s26 | cpu | fallback | no | - | 321 | - | 348.77 | 21.04 | 970.0 | - | Galaxy S26 (SM-S942Q) · Qualcomm SM8850 · litert-lm 0.16.0 · Android 16 | 2026-09-02 | measured |
| galaxy-s26 | gpu | pass | yes | - | 321 | - | 895.06 | 36.46 | 390.0 | - | Galaxy S26 (SM-S942Q) · Qualcomm SM8850 · litert-lm 0.16.0 · Android 16 | 2026-09-02 | measured |
| mac-studio-m4-max | cpu | pass | - | - | - | - | 1029.39 | 47.05 | 529.7 | - | Mac Studio (M4 Max) · litert-lm 0.16.0 | 2026-09-02 | measured |
| mac-studio-m4-max | gpu | pass | - | - | - | - | 5722.09 | 197.1 | 58.2 | - | Mac Studio (M4 Max) · litert-lm 0.16.0 | 2026-09-02 | measured |
| pixel-8a | cpu | fallback | no | - | 321 | - | 73.34 | 8.78 | 4490.0 | - | Pixel 8a · Tensor G3 · litert-lm 0.16.0 · Android 16 | 2026-09-05 | measured |
| pixel-8a | gpu | pass | yes | - | 321 | - | 297.4 | 16.79 | 1140.0 | - | Pixel 8a · Tensor G3 · litert-lm 0.16.0 · Android 16 | 2026-09-05 | measured |
